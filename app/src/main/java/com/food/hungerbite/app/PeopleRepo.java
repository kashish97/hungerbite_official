...
public class PeopleRepo {
    ...
    public static List<Person> getPeople() {
        ...
        people.add(new Person("John", "Washington"));
        people.add(new Person("Thomas", "Washington"));
        people.add(new Person("James", "Madison"));
        people.add(new Person("James", "Madison"));
        people.add(new Person("John Quincy", "Madison"));
        people.add(new Person("Andrew", "Madison"));
        ...
        people.add(new Person("James", "Pierce"));
        people.add(new Person("Abraham", "Pierce"));
        people.add(new Person("Andrew", "Pierce"));
